...
from services.block_scheduler import get_train_corridor_window, min_to_hhmm, _priority
from services.train_position_calculator import sort_stops_chronologically

BASE_DIR = Path(__file__).resolve().parent.parent
DB_FILE = BASE_DIR / "train_cache.db"
OUTPUT_FILE = BASE_DIR / "data" / "gap_schedules.json"
