...
DB_PATH = _ROOT / "data" / "train_cache.db"
JSON_PATH = _ROOT / "data" / "simulated_trains.json"
CSV_PATH = _ROOT / "simulated_trains_delay_analysis.csv"  # kept at root for easy access
