...
DB_FILE = DATA_DIR / "train_cache.db"
JSON_FILE = DATA_DIR / "simulated_trains.json"
CSV_FILE = BASE_DIR / "simulated_trains_delay_analysis.csv"  # kept at root for easy access
